...
public class FrmEjercicio02 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 190, 160, 30));
        ...
        getContentPane().add(btnAscendente, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 110, 160, 30));
        ...
        btnBuscarRecursivo.setText("Buscar Recursivamente");
        btnBuscarRecursivo.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnBuscarRecursivoActionPerformed(evt);
            }
        });
        getContentPane().add(btnBuscarRecursivo, new org.netbeans.lib.awtextra.AbsoluteConstraints(200, 150, 160, 30));
    ...
    private void btnAscendenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAscendenteActionPerformed
      if (vectorReales.getTotalElementos() > 0)
            if (!txtValor.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "La posición es: " + vectorReales.interpolationSearch(Integer.parseInt(txtValor.getText())));
                vectorReales.mostrar(modelo);
            } else {
    ...
    private void btnBuscarRecursivoActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnBuscarRecursivoActionPerformed
        // TODO add your handling code here:
          if (vectorReales.getTotalElementos() > 0)
            if (!txtValor.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "La posición es: " + vectorReales.recursiveInterpolationSearch(Integer.parseInt(txtValor.getText())));
                vectorReales.mostrar(modelo);
            } else {
                JOptionPane.showMessageDialog(null, "La caja de texto esta vacia");
            }
