...
public class FrmEjercicio02 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 90, 100, -1));
        ...
        getContentPane().add(btnIngresar, new org.netbeans.lib.awtextra.AbsoluteConstraints(220, 20, 130, 30));
        ...
        getContentPane().add(btnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 200, 150, 30));
        ...
        getContentPane().add(txtValor, new org.netbeans.lib.awtextra.AbsoluteConstraints(240, 110, 80, 40));
        ...
        getContentPane().add(btnAscendente, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 160, 150, 30));
        ...
        btnOrdenar.setText("Ordenar Ascendente");
        btnOrdenar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnOrdenarActionPerformed(evt);
            }
        });
        getContentPane().add(btnOrdenar, new org.netbeans.lib.awtextra.AbsoluteConstraints(210, 60, 150, 30));
    ...
    private void btnAscendenteActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnAscendenteActionPerformed
      if (vectorReales.getTotalElementos() > 0)
            if (!txtValor.getText().isEmpty()) {
                JOptionPane.showMessageDialog(null, "La posición es: " + vectorReales.busquedaLinealAscendente(Double.parseDouble(txtValor.getText())));
            } else {
