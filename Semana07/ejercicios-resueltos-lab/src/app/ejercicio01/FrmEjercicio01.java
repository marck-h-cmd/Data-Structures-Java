...
public class FrmEjercicio01 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        btnIsertar1 = new javax.swing.JButton();
        ...
        getContentPane().add(btnIsertar, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 220, 150, 30));
        ...
        getContentPane().add(btnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 260, 150, 30));
        ...
        btnIsertar1.setText("Insertar");
        btnIsertar1.setPreferredSize(new java.awt.Dimension(80, 25));
        btnIsertar1.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnIsertar1ActionPerformed(evt);
            }
        });
        getContentPane().add(btnIsertar1, new org.netbeans.lib.awtextra.AbsoluteConstraints(260, 20, 150, 30));
    ...
    private void btnContarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnContarActionPerformed
        ...
        if (LC.contar() > 0) {
            ...
            JOptionPane.showMessageDialog(null, "El total de elementos es: " + LC.contar());
    ...
    private void btnIsertar1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnIsertar1ActionPerformed
        try {
            if (!txtNumero.getText().isEmpty()) {
                int valor = Integer.parseInt(txtNumero.getText());
                txtNumero.setText("");
    ...
    }//GEN-LAST:event_btnIsertar1ActionPerformed
    ...
    private javax.swing.JButton btnIsertar1;
