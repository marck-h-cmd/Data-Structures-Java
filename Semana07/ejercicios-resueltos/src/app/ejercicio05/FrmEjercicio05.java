...
public class FrmEjercicio05 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        getContentPane().add(btnIsertar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 80, 170, 40));
        ...
        getContentPane().add(btnSalir, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 210, 170, 40));
        ...
        btnOrdenar.setText("Ordenar Pares e Imapares");
        btnOrdenar.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnOrdenarActionPerformed(evt);
            }
        });
        getContentPane().add(btnOrdenar, new org.netbeans.lib.awtextra.AbsoluteConstraints(250, 140, 170, 40));
